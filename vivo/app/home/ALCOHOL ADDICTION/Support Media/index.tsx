 ...
 <View style={styles.videoTitleBox}>
        ...
        <>
          ...
          <View style={styles.categoryButtonContainer}>
            ...
            <TouchableOpacity
              onPress={() => handleCategoryChange('relaxing audiobooks for alcohol addiction ')}
              style={[
                styles.categoryButton,
                selectedCategory === 'relaxing audiobooks for alcohol addiction ' && styles.selectedCategoryButton,
              ]}
            >
