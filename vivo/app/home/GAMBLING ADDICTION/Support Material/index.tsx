 ...
 <View style={styles.videoTitleBox}>
        ...
        <>
          ...
          <View style={styles.categoryButtonContainer}>
            ...
            <TouchableOpacity
              onPress={() => handleCategoryChange('relaxing audiobooks for gaming addiction ')}
              style={[
                styles.categoryButton,
                selectedCategory === 'relaxing audiobooks for gaming  addiction ' && styles.selectedCategoryButton,
              ]}
            >
