 ...
 <View style={styles.videoTitleBox}>
        ...
        <>
          ...
          <View style={styles.categoryButtonContainer}>
            ...
            <TouchableOpacity
              onPress={() => handleCategoryChange('relaxing audiobooks for gambling addiction')}
              style={[
                styles.categoryButton,
                selectedCategory === 'relaxing audiobooks for gambling addiction' && styles.selectedCategoryButton,
              ]}
            >
